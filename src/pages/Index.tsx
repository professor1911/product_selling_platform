    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-all duration-300">
      ...
      <section className="container mx-auto px-4 py-20 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-3xl mx-4 mb-20 shadow-xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm animate-fade-in">
      ...
      <section className="container mx-auto px-4 py-20 text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl mx-4 mb-20 text-white shadow-2xl">
        ...
        <Button 
          onClick={() => setShowAuth(true)}
          size="lg"
          className="bg-white text-blue-600 hover:bg-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-lg px-8 py-3 font-semibold"
        >
